...
- Review fix, 2026-08-24 — cold review #5015229485 found that five small status/metadata color pairs fell below WCAG’s 4.5:1 normal-text contrast threshold. The success text, accent numerals, output labels, and skill-status badges were darkened to measured ratios of 5.12:1–5.71:1 without changing layout or content.
