...
# here, so this script sets it only after seeing `checks` land on main. (#94 folded what
# were six separate jobs — consistency, record, plan-gate, title-gate, blockers,
